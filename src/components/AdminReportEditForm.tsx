...
import { adminUpdateReportAction, type SaveReportState } from "@/lib/actions/report";
import type { Dictionary } from "@/lib/i18n/dictionaries";

const initialState: SaveReportState = { success: false };

export default function AdminReportEditForm({
  report,
  t,
}: {
  report: {
    ...
    >
      ...
      <div>
        ...
        <input
          ...
          min={0}
          step={1}
          defaultValue={report.visitorCount}
